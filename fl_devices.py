...
class Client(FederatedTrainingDevice):
    def __init__(self, model_fn, optimizer_fn, data, idnum, batch_size=50, train_frac=1.0):
...
class Server(FederatedTrainingDevice):
    ...
    def aggregate_weight_updates(self, clients):
        reduce_add_average(targets=[client.W for client in clients], sources=[client.dW for client in clients])
